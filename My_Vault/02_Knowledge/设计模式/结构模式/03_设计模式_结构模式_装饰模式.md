...
aliases:
  -
description: **装饰模式**是一种结构型设计模式， 允许你通过将对象放入包含行为的特殊封装对象中来为原对象绑定新的行为。
draft: false
---
...
![jpg](https://refactoringguru.cn/images/patterns/diagrams/decorator/solution2-zh.png)


客户端代码必须将基础通知器放入一系列自己所需的装饰中。 因此最后的对象将形成一个栈结构。

![jpg](https://refactoringguru.cn/images/patterns/diagrams/decorator/solution3-zh.png)
...
![jpg](https://refactoringguru.cn/images/patterns/diagrams/decorator/structure.png)


![jpg](https://refactoringguru.cn/images/patterns/diagrams/decorator/example.png)
